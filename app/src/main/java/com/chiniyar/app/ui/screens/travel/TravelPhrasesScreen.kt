...
private val travelPhrases = listOf(
    TravelPhrase("你好", "Nǐ hǎo", "سلام"),
    TravelPhrase("谢谢", "Xièxie", "ممنون"),
    TravelPhrase("不客气", "Bú kèqi", "خواهش می‌کنم"),
    TravelPhrase("对不起", "Duìbuqǐ", "ببخشید / متأسفم"),
    TravelPhrase("没关系", "Méi guānxi", "اشکالی ندارد"),
    TravelPhrase("请问，洗手间在哪里？", "Qǐngwèn, xǐshǒujiān zài nǎlǐ?", "ببخشید، سرویس بهداشتی کجاست؟"),
    TravelPhrase("这个多少钱？", "Zhège duōshao qián?", "این چقدر قیمت دارد؟"),
    TravelPhrase("太贵了", "Tài guì le", "خیلی گران است"),
    TravelPhrase("可以便宜一点吗？", "Kěyǐ piányi yìdiǎn ma?", "می‌شود کمی ارزان‌تر حساب کنید؟"),
    TravelPhrase("我要这个", "Wǒ yào zhège", "این را می‌خواهم"),
    TravelPhrase("不要辣", "Bú yào là", "تند نباشد"),
    TravelPhrase("我不吃猪肉", "Wǒ bù chī zhūròu", "من گوشت خوک نمی‌خورم"),
    TravelPhrase("请给我一瓶水", "Qǐng gěi wǒ yì píng shuǐ", "لطفاً یک بطری آب به من بدهید"),
    TravelPhrase("我想去这里", "Wǒ xiǎng qù zhèlǐ", "می‌خواهم به اینجا بروم"),
    TravelPhrase("请带我去这个地址", "Qǐng dài wǒ qù zhège dìzhǐ", "لطفاً من را به این آدرس ببرید"),
    TravelPhrase("地铁站在哪里？", "Dìtiě zhàn zài nǎlǐ?", "ایستگاه مترو کجاست؟"),
    TravelPhrase("火车站在哪里？", "Huǒchē zhàn zài nǎlǐ?", "ایستگاه قطار کجاست؟"),
    TravelPhrase("机场怎么走？", "Jīchǎng zěnme zǒu?", "چطور به فرودگاه بروم؟"),
    TravelPhrase("请帮帮我", "Qǐng bāngbang wǒ", "لطفاً به من کمک کنید"),
    TravelPhrase("我听不懂", "Wǒ tīng bù dǒng", "متوجه نمی‌شوم"),
    TravelPhrase("请说慢一点", "Qǐng shuō màn yìdiǎn", "لطفاً کمی آهسته‌تر صحبت کنید"),
    TravelPhrase("你会说英语吗？", "Nǐ huì shuō Yīngyǔ ma?", "انگلیسی صحبت می‌کنید؟"),
    TravelPhrase("请写下来", "Qǐng xiě xiàlái", "لطفاً آن را بنویسید"),
    TravelPhrase("我需要医生", "Wǒ xūyào yīshēng", "به پزشک نیاز دارم"),
    TravelPhrase("医院在哪里？", "Yīyuàn zài nǎlǐ?", "بیمارستان کجاست؟"),
    TravelPhrase("我迷路了", "Wǒ mílù le", "گم شده‌ام"),
    TravelPhrase("有无线网络吗？", "Yǒu wúxiàn wǎngluò ma?", "وای‌فای دارید؟"),
    TravelPhrase("密码是多少？", "Mìmǎ shì duōshao?", "رمز چیست؟"),
    TravelPhrase("请给我一张票", "Qǐng gěi wǒ yì zhāng piào", "لطفاً یک بلیت به من بدهید"),
...
fun TravelPhrasesScreen(onBack: () -> Unit) {
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text("عبارات سفر", fontWeight = FontWeight.Bold) },
                navigationIcon = {
            ...
            if (isSpeaking) {
                Card(
                    ...
                    Row(
                        ...
                        Text("در حال پخش تلفظ…", fontWeight = FontWeight.Bold)
                        IconButton(onClick = ::stopSpeaking) {
                            Icon(Icons.Default.Stop, contentDescription = "توقف پخش")
                        }
                    }
                }
            }
                        ...
                        Row(
                            ...
                            IconButton(
                                ...
                                Icon(
                                    ...
                                    contentDescription = if (speakingPhrase == phrase.chinese) "توقف تلفظ" else "پخش تلفظ",
                                    tint = colors.primary
                                )
                            }
                            Column(
